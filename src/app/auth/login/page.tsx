        ...
        <div className="text-center">
          <Link href="/" className="flex items-center justify-center space-x-2 mb-6">
            ...
            <div className="flex flex-col">
              <span className="text-2xl font-bold text-gray-900">Islamic School</span>
              <span className="text-sm text-gray-600">& Religious Center</span>
            </div>
          </Link>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-gray-900 placeholder-gray-500"
