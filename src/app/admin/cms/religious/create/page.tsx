        ...
        <header className="bg-surface p-6 rounded-lg shadow-card mb-8">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <h1 className="text-3xl font-bold text-foreground">Create Religious Content</h1>
                    <p className="text-text-secondary mt-1">Add new Islamic content to your website</p>
                </div>
